...
DEFAULT_SUFFIX = wasi-debug

COMPILERS := GCC GCC_I686 CLANG CLANG_I686 EMCC WASI
...
WASI_FLAG := -DCMAKE_C_COMPILER=wasix-cc -DWASI=1 -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DCMAKE_CXX_COMPILER=wasix-c++ \
    -DBUILD_LIBWASM=OFF -DBUILD_TESTS=OFF -DCMAKE_CROSSCOMPILING=TRUE -DCMAKE_CXX_COMPILER_WORKS=1 -DCMAKE_C_COMPILER_WORKS=1 -DWABT_INSTALL_RULES:BOOL=OFF
